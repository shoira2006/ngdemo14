...
import 'package:ngdemo14/service/log_service.dart';

import '../model/post_create_res.dart';
import '../model/post_list_res.dart';
...
/* Http Parsing */
  ...
  static List<PostListRes> parsePostList(String response) {
    return postListResFromJson(response);
  }

  static PostCreateRes parsePostCreate(String response) {
    return postCreateResFromJson(response);
  }
}
